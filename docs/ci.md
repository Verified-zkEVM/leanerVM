...
| --- | --- | --- |
| `CI` | Build with the Actions and Mathlib caches, run the Lake test driver, audit production and test axiom dependencies with a negative control, and elaborate the test root with warnings as errors | Required |
